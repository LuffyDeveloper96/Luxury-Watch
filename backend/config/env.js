...
export const env = {
  ...
  EMAIL_APP_PASSWORD: (process.env.EMAIL_APP_PASSWORD || process.env.EMAIL_PASSWORD || '').trim(),
  EMAIL_FROM_NAME: (process.env.EMAIL_FROM_NAME || 'LUXURY WATCH Concierge').trim(),
