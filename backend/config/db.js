...
// Initial Seed Data for Luxury Watch
const INITIAL_SEED = {
  products: [
    {
    ...
    },
    {
      ...
      isBestSeller: true,
      isNew: false,
      images: ["/images/watches/omega_speedmaster.jpg"],
      description: "The legendary timepiece that went to the Moon on Apollo 11. Powered by the Master Chronometer-certified Calibre 3861 manual-wind movement, featuring the iconic dot over ninety on the bezel.",
      specs: {
      ...
      colors: [{ name: "Moonwatch Matte Black", hex: "#18181b", imageIndex: 0 }],
      straps: [
    ...
    },
    {
      ...
      description: "The holy grail of luxury sports watches. Rounded octagonal porthole bezel, horizontally embossed blue-black gradated dial, and exquisitely satin-brushed integrated bracelet.",
      specs: {
      ...
      colors: [{ name: "Blue Sunburst Dégradé", hex: "#1e3a8a", imageIndex: 0 }],
      straps: [{ name: "Integrated Steel Bracelet", id: "nautilus-steel" }],
    ...
    },
    {
      ...
      isBestSeller: true,
      isNew: false,
      images: ["/images/watches/audemars_royal_oak.jpg"],
      description: "An icon that revolutionized luxury watchmaking. Featuring the unmistakable octagonal bezel secured by 8 polished white gold hexagonal screws, Bleu Nuit Grande Tapisserie dial, and integrated bracelet.",
      specs: {
      ...
      colors: [{ name: "Bleu Nuit Tapisserie", hex: "#1e293b", imageIndex: 0 }],
      straps: [{ name: "Royal Oak Steel Bracelet", id: "ap-steel" }],
    ...
    },
    {
      ...
      isBestSeller: true,
      isNew: false,
      images: ["/images/watches/cartier_santos.jpg"],
      description: "The world's first modern wristwatch. Distinctive square case with rounded corners, exposed screws on bezel and bracelet, and seven-sided crown set with a faceted blue synthetic spinel.",
      specs: {
      ...
      colors: [{ name: "Silver Opaline & Blued Steel", hex: "#e2e8f0", imageIndex: 0 }],
      straps: [
    ...
    },
    {
      ...
      isBestSeller: false,
      isNew: true,
      images: ["/images/watches/tag_heuer_monaco.jpg"],
      description: "The timeless racing chronograph made legendary by Steve McQueen in 'Le Mans'. Famous left-sided crown, square 39mm case, striking metallic blue dial, and horizontal faceted hour markers.",
      specs: {
      ...
      colors: [{ name: "Racing Petroleum Blue", hex: "#0369a1", imageIndex: 0 }],
      straps: [
    ...
    },
    {
      ...
      isBestSeller: true,
      isNew: false,
      images: ["/images/watches/breitling_navitimer.jpg"],
      description: "The world's most iconic pilot's chronograph since 1952. Equipped with the legendary circular slide rule for calculating flight plans, contrasting panda subdials, and manufacture B01 movement.",
      specs: {
      ...
      colors: [{ name: "Panda Reverse Black", hex: "#111827", imageIndex: 0 }],
      straps: [
    ...
    },
    {
      ...
      isBestSeller: true,
      isNew: true,
      images: ["/images/watches/tissot_prx.jpg"],
      description: "The retro 1978 design sensation with modern horology technology. Integrated tonneau case with an ice blue embossed waffle dial and an astounding 80-hour power reserve.",
      specs: {
      ...
      colors: [{ name: "Glacier Ice Blue", hex: "#7dd3fc", imageIndex: 0 }],
      straps: [
    ...
    },
    {
      ...
      isBestSeller: false,
      isNew: true,
      images: ["/images/watches/patek_tourbillon.jpg"],
      ...
      colors: [{ name: "Rose Gold & Titanium Skeleton", hex: "#d4af37", imageIndex: 0 }],
      straps: [
  ...
  orders: [
    {
      ...
      client: {
        ...
        address: "A-402, Imperial Towers, Altamount Road",
        city: "Mumbai",
        state: "Maharashtra",
        postalCode: "400026",
        country: "India"
      ...
      items: [
        {
          ...
          engravingText: "SINGHANIA • MMXXVI",
      ...
      shippingCost: 0,
      shippingSpeed: "BlueDart Insured Air Express",
      total: 4949,
      paymentMethod: "UPI Instant (singhania@okhdfcbank)",
      notes: "Please deliver in luxury wooden presentation box."
    }
  ],
  reviews: [
    {
  ...
  activityLog: [
    ...
    { id: "act-2", text: "New order ORD-LW-98421 placed for ₹4,949", time: "12m ago", type: "order" },
    { id: "act-3", text: "5-star review posted by Vikramaditya S. (Mumbai)", time: "45m ago", type: "review" },
    { id: "act-4", text: "VIP Collector applied code LUXE10 in cart", time: "1h ago", type: "coupon" }
  ],
  admin: {
    email: "admin@luxurywatch.com",
    role: "Grand Horologist / Master Administrator",
    lastLogin: "2026-08-25T00:00:00Z"
  }
};
